...
import { Search, Plus, Edit2, Trash2, Eye, Shield, ShieldOff, UserCheck, Save, Loader2, User } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Mô tả / Bio</label>
            <textarea
              value={bio}
