...
"[project]/app/(main)/portal/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PortalPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PortalPage.useEffect": ()=>{
            let mounted = true;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$orders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listMyOrders"])({
                page: 1,
                perPage: 50,
                expand: 'san_pham'
            }).then({
                "PortalPage.useEffect": (res)=>{
                    if (!mounted) return;
                    const mapped = res.items.filter({
                        "PortalPage.useEffect.mapped": (o)=>o.trang_thai_su_dung === 'dang_su_dung' || o.host_url
                    }["PortalPage.useEffect.mapped"]).map({
                        "PortalPage.useEffect.mapped": (o)=>{
                            const sanPham = o.expand?.san_pham || {};
                            const ghiChu = o.ghi_chu_noi_bo || '';
                            let domain = '';
                            if (ghiChu.includes('|')) {
                                const parts = ghiChu.split('|').map({
                                    "PortalPage.useEffect.mapped.parts": (s)=>s.trim()
                                }["PortalPage.useEffect.mapped.parts"]);
                                const domainPart = parts.find({
                                    "PortalPage.useEffect.mapped.domainPart": (s)=>s.toLowerCase().startsWith('domain')
                                }["PortalPage.useEffect.mapped.domainPart"]);
                            ...
                            return {
                                ...
                                serverName: ({
                                    "PortalPage.useEffect.mapped": ()=>{
                                        try {
                                            return o.host_url ? new URL(o.host_url).hostname : '-';
                                        } catch  {
                                            return o.host_url || '-';
                                        }
                                    }
            ...
            }["PortalPage.useEffect"]).catch({
                "PortalPage.useEffect": ()=>{}
            }["PortalPage.useEffect"]).finally({
                "PortalPage.useEffect": ()=>{
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    ...
                                    fileName: "[project]/app/(main)/portal/page.tsx",
                                    lineNumber: 74,
                                    columnNumber: 13
                                }, this),
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-gray-600",
                                    children: "Quản lý dịch vụ và thanh toán"
                                }, void 0, false, {
                                    fileName: "[project]/app/(main)/portal/page.tsx",
                                    lineNumber: 75,
                                    columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: services.filter((s)=>s.status === 'expired' || s.status === 'suspended').length
                                            }, void 0, false, {
                                                fileName: "[project]/app/(main)/portal/page.tsx",
                                                lineNumber: 184,
                                                columnNumber: 17
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                className: "text-xl font-bold text-[#0B2B6F]",
                                children: "Dịch vụ của bạn"
                            }, void 0, false, {
                                fileName: "[project]/app/(main)/portal/page.tsx",
                                lineNumber: 195,
                                columnNumber: 13
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: `px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${service.status === 'active' ? 'bg-green-100 text-green-800' : service.status === 'suspended' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800'}`,
                                                            children: service.status === 'active' ? 'Đang hoạt động' : service.status === 'suspended' ? 'Đình chỉ' : 'Hết hạn'
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/(main)/portal/page.tsx",
                                                            lineNumber: 245,
                                                            columnNumber: 23
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                className: "text-[#034CC9] hover:text-[#0B2B6F] font-semibold mr-3",
                                                                children: "Gia hạn"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/(main)/portal/page.tsx",
                                                                lineNumber: 256,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Liên hệ đội ngũ hỗ trợ 24/7 của chúng tôi để được giúp đỡ"
                        }, void 0, false, {
                            fileName: "[project]/app/(main)/portal/page.tsx",
                            lineNumber: 273,
                            columnNumber: 11
...
_s(PortalPage, "+Z0yz3iL42vGLYB4TfDqL3z1C5o=", false, function() {
    return [
...
//# sourceMappingURL=_bda67931._.js.map