...
function PaymentQRContent() {
    ...
    const qrUrl = orderId && amount ? `https://qr.sepay.vn/img?acc=${BANK.accountNumber}&bank=${BANK.bankName}&amount=${amount}&des=${encodeURIComponent(orderId)}` : '';
...
_s(PaymentQRContent, "7g0aenQic2YsiOggkYoR8iVX1Sg=", false, function() {
    return [
