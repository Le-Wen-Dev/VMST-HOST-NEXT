...
function PortalPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        let mounted = true;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$orders$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["listMyOrders"])({
            page: 1,
            perPage: 50,
            expand: 'san_pham'
        }).then((res)=>{
            if (!mounted) return;
            const mapped = res.items.filter((o)=>o.trang_thai_su_dung === 'dang_su_dung' || o.host_url).map((o)=>{
                const sanPham = o.expand?.san_pham || {};
                const ghiChu = o.ghi_chu_noi_bo || '';
                let domain = '';
                if (ghiChu.includes('|')) {
                    const parts = ghiChu.split('|').map((s)=>s.trim());
                    const domainPart = parts.find((s)=>s.toLowerCase().startsWith('domain'));
...
//# sourceMappingURL=_30b53bb1._.js.map