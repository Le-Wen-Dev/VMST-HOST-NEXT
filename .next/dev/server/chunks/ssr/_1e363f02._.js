...
"[project]/services/emailService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const EMAILJS_PUBLIC_KEY = process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY || 'X9ipjr3nt4vcZwFhv';
const ADMIN_EMAIL = 'lequelcm@gmail.com';
let initialized = false;
function ensureInitialized() {
    if (!initialized && EMAILJS_PUBLIC_KEY) {
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$emailjs$2f$browser$2f$es$2f$methods$2f$init$2f$init$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["init"])(EMAILJS_PUBLIC_KEY);
            initialized = true;
...
Vui lòng soạn đơn và liên hệ khách hàng để kích hoạt dịch vụ.
    `.trim();
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$emailjs$2f$browser$2f$es$2f$methods$2f$send$2f$send$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["send"])(EMAILJS_SERVICE_ID, EMAILJS_TEMPLATE_ID, templateParams);
...
"[project]/services/adminNotifications.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$tickets$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/tickets.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$emailService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/emailService.ts [app-ssr] (ecmascript)");
;
;
...
async function notifyAdminNewOrder(order, ctx = {}) {
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$tickets$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createTicket"])({
            tieu_de: subject,
            tin_nhan: lines.join('\n'),
            don_hang: order.id,
    ...
    console.log('[notifyAdminNewOrder] isEmailJSConfigured:', (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$emailService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isEmailJSConfigured"])());
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$emailService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isEmailJSConfigured"])() && customerData) {
        try {
            ...
            const emailSent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$emailService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendOrderNotificationEmail"])({
                orderId: order.id,
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$emailService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isEmailJSConfigured"])()) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$adminNotifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/adminNotifications.ts [app-ssr] (ecmascript)");
...
function CheckoutPage() {
    ...
    const { isLoggedIn, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const { showError, showWarning, showSuccess } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$ToastContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
    const { cart, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$CartContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const [voucherCode, setVoucherCode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [appliedVoucher, setAppliedVoucher] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [voucherError, setVoucherError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [isProcessing, setIsProcessing] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isApplyingVoucher, setIsApplyingVoucher] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [localCart, setLocalCart] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(cart);
    ...
    const handleApplyVoucher = async ()=>{
        ...
        setVoucherError('');
        try {
            const voucher = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$vouchers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getVoucherByCode"])(voucherCode.trim());
            if (!voucher) {
            ...
            if (voucher.code_giam_gia.toUpperCase() === 'VOVANMY2026') {
                ...
                try {
                    const checkResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$studentVouchers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["checkStudentEmail"])(user.email);
            ...
            const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$vouchers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateVoucherDiscount"])(voucher, subtotal);
    ...
    const discount = appliedVoucher ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$vouchers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateVoucherDiscount"])(appliedVoucher, subtotal).discount : 0;
        ...
        try {
            ...
            if (appliedVoucher) {
                try {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$vouchers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateVoucher"])(appliedVoucher.id, {
            ...
            const createdOrder = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$orders$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createMyOrder"])({
            ...
            if (appliedVoucher && appliedVoucher.code_giam_gia.toUpperCase() === 'VOVANMY2026' && user?.email) {
                if (total === 0) {
                    try {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$studentVouchers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markStudentEmailUsed"])(user.email, orderId);
            ...
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$adminNotifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["notifyAdminNewOrder"])(createdOrder, {
                    customer: {
                        name: formData.name,
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: !appliedVoucher ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-2",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                voucherError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                ...
                                                appliedVoucher.ten_chien_dich && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
//# sourceMappingURL=_1e363f02._.js.map