    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-br from-[#034CC9] to-[#0B2B6F] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold">Tư vấn chọn gói Hosting phù hợp – Miễn phí</h1>
          </div>
          <p className="text-xl text-blue-100 text-center max-w-3xl mx-auto">
            Trả lời vài câu hỏi đơn giản để hệ thống gợi ý gói Hosting WordPress hoặc VPS phù hợp nhất với nhu cầu và ngân sách của bạn
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-bold text-[#0B2B6F] mb-6">Xem chi tiết từng gói Hosting</h2>
